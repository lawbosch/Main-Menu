...
void print_info()
{
  Terminal.write("\e[33mESP32 TinyBasic PC with VGA monitor and PS2 keyboard\r\n");
  Terminal.write("\e[32mby Laurence Bosch\e[32m\r\n\n");
...
void loop()
{
  //Serial.println("&with &V&G&A&&& video output"); 
